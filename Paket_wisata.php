                ...
                ?>
                    <div class="col-sm-4 col-xs-12 mb-5">
                        <div class="panel panel-default text-center">
                            <div class="panel-heading" style="background-color:<?php echo $d['bg_warna']; ?>">
                                <h2><?php echo $data1['judul'] ?></h2>
                            </div>
                            <div class="panel-body text-left ml-5 mt-4">
                                <p><strong><?php echo nl2br($data1['deskripsi']); ?></strong></p>

                            </div>
                            <div class="panel-footer">
                                <h5><strong><?php echo nl2br($data1['harga']); ?></strong></h5>
                                <a class="btn btn-lg" href="https://wa.me/<?php echo $data1['no_wa'] ?>">Pesan
                                    via WhatsApp</a>
