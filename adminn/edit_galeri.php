   ...
   <div class="wrapper">
     ...
     <div class="content-wrapper">
       ...
       <?php
        ...
        $data = mysqli_query($koneksi, "select * from galeri WHERE id_galeri='$id_galeri' ");
        while ($d = mysqli_fetch_array($data)) {
        ?>
         <div class="container">
           <div class="row justify-content-center mt-5 ml-5 mb-5">
             <form class="col-8" method="POST" action="proses_edit_galeri.php" enctype="multipart/form-data">
