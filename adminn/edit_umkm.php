   ...
   <div class="wrapper">
     ...
     <div class="content-wrapper">
       ...
       <?php
        ...
        $data = mysqli_query($koneksi, "select * from umkm WHERE id_umkm='$id_umkm' ");
        while ($d = mysqli_fetch_array($data)) {
        ?>
         <div class="container">
           <div class="row justify-content-center mt-5 ml-5 mb-5">
             <form class="col-8" method="POST" action="proses_edit_umkm.php" enctype="multipart/form-data">
               <input type="hidden" name="id_umkm" value="<?php echo $d['id_umkm'] ?>">
               ...
               <div class="form-group ">
                 ...
                 <textarea name="deskripsi" rows="3" class="form-control"><?php echo $d['deskripsi'] ?></textarea>
               </div>
               <div class=" form-group ">
               ...
               <div class=" form-group ">
                 ...
                 <input type="text" name="wa" class="form-control" value="<?php echo $d['no_wa'] ?>">
               </div>



               <button type="submit" class="btn btn-warning" name="Tambah">Ubah</button>
             </form>
           </div>
         </div>
         <!-- /.content -->
