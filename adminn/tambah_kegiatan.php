      ...
      <div class="content-wrapper">
        ...
        <div class="container">
          <div class="row justify-content-center mt-5 ml-5 mb-5">
            <form class="col-8" method="POST" action="proses_tambah_kegiatan.php" enctype="multipart/form-data">
              ...
              <div class="form-group ">
                ...
                <textarea maxlength=”500″ name="deskripsi" rows="3" class="form-control"></textarea>
              </div>
