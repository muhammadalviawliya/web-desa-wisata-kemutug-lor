 <?php
  ...
  $data = mysqli_query($koneksi, "select * from carousel WHERE id_carousel='$id_carousel' ");
       ...
       <div class="content-wrapper">
         ...
         <div class="container">
           <div class="row justify-content-center mt-5 ml-5 mb-5">
             <form class="col-8" method="POST" action="proses_edit_carousel.php" enctype="multipart/form-data">
               <input type="hidden" name="active" value="<?php echo $d['active'] ?>">
